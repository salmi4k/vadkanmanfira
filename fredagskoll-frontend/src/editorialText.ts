...
export function getOrdinaryThemeDayCardNotes(locale: Locale, mood: Mood): string[] {
  switch (mood) {
    case 'cheerful':
      return [
        byLocale(locale, { sv: 'Det är ingen officiell svensk högtidsdag, men tillräckligt många ville uppenbarligen ge dagen lite liv.', en: 'It is not an official Swedish holiday, but clearly enough people wanted to give the day some life.', 'pt-BR': 'Nao e um feriado oficial sueco, mas gente suficiente claramente quis dar alguma vida ao dia.' }),
    ...
    case 'formal':
      return [
        byLocale(locale, { sv: 'Detta är ingen officiell svensk högtidsdag, men tillräckligt etablerat för att kunna behandlas med viss seriositet.', en: 'This is not an official Swedish holiday, but sufficiently established to be treated with some seriousness.', 'pt-BR': 'Isto nao e um feriado oficial sueco, mas esta suficientemente estabelecido para receber alguma seriedade.' }),
    ...
    case 'warm':
      return [
        byLocale(locale, { sv: 'Det är ingen officiell svensk högtidsdag, men någon tog ändå sig tid att ge dagen lite ryggrad.', en: 'It is not an official Swedish holiday, but someone still took the time to give the day a little backbone.', 'pt-BR': 'Nao e um feriado oficial sueco, mas alguem ainda assim se deu ao trabalho de dar alguma espinha ao dia.' }),
    ...
    case 'chaotic':
      return [
        byLocale(locale, { sv: 'Det är ingen officiell svensk högtidsdag, men tillräckligt många har tydligen kastat energi på datumet för att det ska börja låta som ett beslut.', en: 'It is not an official Swedish holiday, but enough people have clearly thrown energy at the date for it to start sounding like policy.', 'pt-BR': 'Nao e um feriado oficial sueco, mas gente suficiente claramente atirou energia na data para isso comecar a soar como politica publica.' }),
    ...
    case 'absurd':
      return [
        byLocale(locale, { sv: 'Det är ingen officiell svensk högtidsdag, men tillräckligt många människor tittade på datumet och gav det en märklig liten hatt.', en: 'It is not an official Swedish holiday, but enough people looked at the date and gave it a strange little hat.', 'pt-BR': 'Nao e um feriado oficial sueco, mas gente suficiente olhou para a data e lhe deu um chapeuzinho esquisito.' }),
    ...
    default:
      return [
        byLocale(locale, { sv: 'Det är ingen officiell svensk högtidsdag, men tillräckligt många har uppenbarligen bestämt sig för att göra något av det här datumet.', en: "It's not an official Swedish holiday, but clearly enough people decided this date deserved some sort of content.", 'pt-BR': 'Nao e um feriado oficial sueco, mas claramente gente suficiente resolveu que essa data merecia algum conteudo.' }),

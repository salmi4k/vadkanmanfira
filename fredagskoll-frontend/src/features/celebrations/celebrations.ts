...
const celebrationsSv: Record<Exclude<DayType, 'ordinary'>, CelebrationContent> = {
  ...
  fettisdag: {
    title: 'Fettisdag. Nationen hålls ihop av grädde.',
    subtitle: 'Semlan leder, resten av dagen får försöka hänga med.',
    kicker: 'Mandelmassa och sammanbrott',
    alt: 'Fettisdag',
    blurbs: [
      'Fettisdagen är när hela landet beter sig som om vispgrädde vore ett fullt rimligt styrmedel.',
      'Det här är dagen då lunch gärna får se ut som en semla och ingen anständig människa orkar invända.',
      'Semlan står där som ett bakverk byggt på övermod, kardemumma och fullständig kulturell immunitet.',
      'På Fettisdagen räcker det att någon öppnar en kartong för att ett helt kontor ska tappa all strategisk skärpa.',
      'Mandelmassa, grädde och ett tunt lager självbedrägeri håller ihop datumet bättre än någon egentlig planering.',
      'Det här är den enda dagen då folk kan beskriva bulle som tradition, plikt och personlighet utan att skämmas.',
      'Allt med Fettisdagen signalerar att disciplin är överskattat så länge någon hunnit till bageriet.',
      'Det är semlans stora dag, och resten av kalendern får acceptera att den tillfälligt blivit bihandling.',
      'Fettisdagen har exakt rätt svensk blandning av allvar, socker och dåligt portionerad återhållsamhet.',
      'Den här dagen drivs av grädde, kollektiv förväntan och en märkligt oresonlig vilja att kalla allt detta rimligt.',
      'Fettisdagen fungerar eftersom ingen längre låtsas att det bara handlar om ett vanligt bakverk.',
      'Dagen har bara två verkliga lägen: semla nu eller semla inom överskådlig framtid.',
    ],
  ...
  valborg: {
    title: 'Valborg. Nu räcker april och alla går ut ändå.',
    subtitle: 'Brasa, körsång och tunn jacka mot bättre vetande.',
    kicker: 'Sista april',
    blurbs: [
      'Valborg är den officiella övergången från apriltrötthet till utomhusromantik med tveksamt väderomdöme.',
      'Det här är kvällen då en brasa, lite körsång och ett lätt vårdrabbat självförtroende räcker för att bära nationen.',
      'Sista april gör hela landet märkbart mindre intresserat av ordning och betydligt mer intresserat av eld.',
      'Valborg är när folk kliver ut i för tunna jackor och beter sig som om temperaturen vore en förhandlingsfråga.',
      'Allt efter lunch är mest en administrativ kuliss framför ett mycket starkare behov av att stå nära en brasa.',
      'Brasan kallar, pollen anfaller och omdömet får finna sig i att stå lite åt sidan för en kväll.',
      'Valborg känns som en kollektiv överenskommelse om att våren är här, även när termometern aktivt motsäger den tesen.',
      'Det här är datumet då vårkänslan får högre auktoritet än kalenderdisciplin och märkligt nog brukar vinna.',
      'Ingen vuxen människa ser riktigt balanserad ut på Valborg, men just därför känns högtiden korrekt kalibrerad.',
      'Valborg är i praktiken ett nationellt medgivande om att april bör avslutas med eld, sång och mild planupplösning.',
      'Det finns dagar med bättre struktur. Valborg nöjer sig med stämning, rök och ett övertygat ansiktsuttryck.',
      'Det här är sista april i sin mest svenska form: hoppfull, lätt frusen och helt övertygad om att det ändå är värt det.',
    ],
    primaryImage: '/images/valborg.jpg',
    theme: 'ember',
  },
  nationaldagen: {
    title: 'Nationaldagen. Blågul utan att förlora fattningen.',
    subtitle: 'Flagga, fika och tillfällig välvilja mot landet.',
    kicker: 'Flagga och fika',
    blurbs: [
      'Nationaldagen är den sällsynta svenska högtiden som lyckas vara både officiell och märkbart lågmäld på samma gång.',
      'Det här är dagen då flaggor, kaffebröd och tillfällig välvilja mot fosterlandet bildar ett fullt fungerande upplägg.',
      'Man firar Sverige ungefär som man firar en stabil kollega: respektfullt, utan att göra för stor scen av det.',
      'Nationaldagen kräver inte extas. Den nöjer sig med lite blågult, hygglig stämning och ett minimum av självförakt.',
      'Det är ett datum för flagga, fika och lågmält självförtroende, alltså ungefär så svenskt det kan bli utan att spåra ur.',
      'Blågult tyg får plötsligt en märkligt hög auktoritet över humöret idag och ingen verkar ha något starkt emot det.',
      'Nationaldagen fungerar bäst när ingen försöker göra den större än den är men heller inte låtsas som att den inte räknas.',
      'Det här är en utmärkt dag att uppskatta fungerande kollektivtrafik, rimlig välfärd och att flaggor kan få vara lite charmiga.',
      'Ingen behöver bli patriot på heltid. Det räcker gott att vara tillfälligt välvillig mot landet fram till eftermiddagsfikat.',
      'Nationaldagen är aldrig den mest vilda högtiden i kalendern, men den bär sig med trygg auktoritet och det räcker långt.',
      'Det här datumet ber inte om fyrverkerier. Det ber om värdighet, kaffe och att folk åtminstone försöker bete sig rimligt.',
      'Nationaldagen känns som Sverige i koncentrat: ordnad, lite försiktig, men ändå oväntat trygg när man väl tittar närmare.',
    ],
    primaryImage: '/images/nationaldagen.jpg',
    theme: 'forest',
  },
  midsommarafton: {
    title: 'Midsommarafton. Landet är mentalt otillgängligt.',
    subtitle: 'Sill, jordgubbar och autosvar i mänsklig gestalt.',
    kicker: 'Sill-driven frånvaro',
    blurbs: [
      'Midsommarafton är dagen då hela landet officiellt fortsätter på pappret men praktiskt redan står vid en filt med jordgubbar.',
      'Det här är fredagen då autosvaret i själen aktiveras långt innan någon faktiskt vågar stänga datorn.',
      'Sill, jordgubbar och en kalender full av rena fantasier om tillgänglighet. Svensk perfektion i sin mest avslöjande form.',
      'Ingen meningsfull produktivitet återstår här. Det som finns kvar är logistik, blomsterkransar och lågintensiv flyktberedskap.',
      'Midsommarafton är när Sverige håller öppet i teorin och fullständigt stängt i anden.',
      'Man kan kalla det arbetsdag om man vill, men det ändrar inte att all verklig lojalitet redan ligger i en kylväska.',
      'Sillen är planerad, jordgubbarna kylda och varje sista gnista av ambition försiktigt undanlagd till nästa vecka.',
      'Den enda realistiska leveransen idag är att folk tar sig ut genom dörren i tid utan att fastna i ett sista meningslöst samtal.',
      'Midsommarafton har samma relation till arbete som regn har till pappersdekorationer: formellt möjligt, praktiskt hopplöst.',
      'Det här är dagen då kalendrar hålls öppna av ren vidskepelse och ingen riktigt låtsas tro på dem längre.',
      'Ingen vill vara den som på allvar säger att de är tillgängliga efter lunch, och det är ett sunt samhällstecken.',
      'Samhället fortsätter tekniskt sett, men allt viktigt står redan parkerat i gräset någonstans med dill i närheten.',
    ],
  ...
  julafton: {
    title: 'Julafton. Normal drift är officiellt avbruten.',
    subtitle: 'Traditioner, tidsluckor och kollektivt högtidsvansinne.',
    kicker: 'Kalle, kaffe och kollektiv regression',
    blurbs: [
      'Julafton är den sorts dag där tidtabeller ersätts av glögglogik och ingen riktigt har kraft att invända.',
      'Det är fullt normalt att hela dagen styrs av kaffe, julbord och exakt när någon anser att Kalle måste börja.',
      'Julafton förvandlar annars sansade människor till traditionsoperatörer med starka åsikter om skinka, stearin och soffplacering.',
      'Det här är datumet då soffor, paketpapper och lätt spänd släktsamverkan på något vis lyckas bära nationen hela vägen till kvällen.',
      'Allt på Julafton känns samtidigt minutiöst planerat och fullständigt omöjligt att styra, vilket i praktiken är själva högtiden.',
      'Det här är en dag där kaffe, stearin och undertryckt familjedynamik gör grovjobbet medan granen tar åt sig äran.',
      ...
      'Julafton har sin egen logik och det klokaste man kan göra är att följa med så länge ingen börjar omvärdera sillbordet högt.',
      'Det här är dagen då vuxna människor accepterar scheman byggda kring tecknad tv, julklappar och ett orimligt precist klockslag för mat.',
      'Julafton känns varm just för att den är så nära att spåra ur hela tiden och ändå nästan alltid landar på fötter.',
      'Det här är ett nationellt grupparbete i ljus, paket, diplomati och diskret återhållsam irritation.',
      'Julafton gör soffan till kommandocentral, glöggen till samhällsfunktion och varje filt till strategisk resurs.',
    ],
  ...
  nyarsafton: {
    title: 'Nyårsafton. Midnatt får bära orimligt mycket.',
    subtitle: 'Bubbel, övertro och ett väldigt högt pris på symbolik.',
    kicker: 'Tolvslaget som projekt',
    blurbs: [
      'Nyårsafton är den årliga ritualen där människor låtsas att tolvslaget automatiskt förbättrar karaktären och ändå menar det lite.',
      'Det här är kvällen då bubbel, löften och lätt överskattad framtidstro ska samsas i samma rum utan vuxen övervakning.',
      'Nyårsafton fungerar bäst om ingen ställer för många frågor om planering, skor, raketer eller morgondagens självinsikt.',
      'Allt kulminerar i några minuter av ljud, ljus och kollektivt beslut att nästa år nog ändå blir bättre än det förra.',
      'Det här är en kväll byggd på glitter, förseningar och stark tro på att nedräkning i kör har personlig utvecklingskraft.',
      'Nyårsafton är när människor investerar orimlig symbolik i ett klockslag och ändå lyckas kalla det sunt beteende.',
      'Det här är datumet som kräver bubbel, övertro och skor som ingen egentligen kan stå i efter 22:30.',
      'Man får gärna kalla det nystart. Kalendern kommer ändå märka att du i grunden är samma människa imorgon bitti.',
      'Nyårsafton lever på kombinationen av dyra ambitioner, blank symbolik och mycket korta fyrverkerier.',
      'Midnatt får bära en nästan komiskt stor del av kvällens känslomässiga budget, men den brukar lösa det ändå.',
      'Det här är en högtid där folk planerar minutiöst för att sedan överlåta hela meningen åt några sekunder på balkongen.',
      'Nyårsafton känns alltid lite överdriven, vilket i praktiken är precis varför den fortfarande fungerar.',
    ],

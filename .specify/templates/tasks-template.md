...
- [ ] T004 Define verification scope for content-pack boundaries, exact dates,
      automated tests, and rendered checks
...
- [ ] T012 [P] [US1] Integration or component test for [user journey] in the
      relevant test file
- [ ] T013 [P] [US1] Add fixed-date regression coverage for affected calendar
      behavior when applicable
- [ ] T014 [US1] Document the rendered verification pass for the visible result
...
- [ ] T022 [P] [US2] Integration or component test for [user journey] in the
      relevant test file
- [ ] T023 [US2] Document the rendered verification pass for the visible result
...
- [ ] T029 [P] [US3] Integration or component test for [user journey] in the
      relevant test file
- [ ] T030 [US3] Document the rendered verification pass for the visible result
...
- [ ] TXXX Run final rendered verification in the app or testing environment
